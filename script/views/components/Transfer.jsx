...
class Transfer extends Component {
  ...
  handleChange = () => {
    if (this.props.balance[this.currency.value] < this.amount.value) {
      this.setState({ error: 'Amount entered is more than you own.' });
    } else {
    ...
    return (
      <div className="Transfer card mt-4 mb-3">
        <div className="card-body text-center">
          ...
          <form onSubmit={this.submitTransfer} className="mt-3">
            ...
            <div className="row">
              <div className="input-group mb-4">
                ...
                <div className="col-5 col-md-3">
                  <select className="form-control" ref={el => (this.currency = el)}>
                    <option>NEO</option>
                    <option>GAS</option>
                  </select>
                </div>
